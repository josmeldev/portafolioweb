          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[80vh] py-12">
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="#projects" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
              ...
              <div className="flex justify-center sm:justify-start gap-3 mt-5">
                <a href="https://linkedin.com/in/josmelvergara" target="_blank" rel="noopener noreferrer" className="bg-blue-700 hover:bg-blue-800 text-white px-6 py-2 rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
            ...
            */}
            ...
            <div className="group relative bg-gray-900/80 rounded-xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-300 w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] xl:w-[calc(25%-18px)] max-w-sm flex flex-col min-h-[28rem]">
              <div className="aspect-video relative overflow-hidden bg-gradient-to-br from-cyan-800 to-cyan-600 flex items-center justify-center">
                <img 
                  src="/finanzas.webp" 
                  alt="Presupuesto - App móvil para gestión financiera personal" 
                  className="max-w-full max-h-full object-contain"
                />
                <div className="absolute inset-0 bg-black/20"></div>
                <div className="absolute bottom-4 left-4 right-4">
